// The 101 départements, grouped by région.
//
// Source: INSEE, Code officiel géographique 2026 — v_region_2026.csv and
// v_departement_2026.csv, https://www.insee.fr/fr/information/8377162
//
// Written out rather than derived from the rows: the filter has to offer every
// département, including those where no plan is situated yet. Redo by hand when the
// COG 2027 is published.
import type { MultiSelectGroup } from '@shared/components/MultiSelect'

export const LIEU_OPTIONS: readonly MultiSelectGroup<string>[] = [
    {
        id: '84',
    ...
    },
    {
        id: '01',
        label: 'Guadeloupe',
        options: [{ value: '971', label: 'Guadeloupe (971)' }],
    },
    {
        id: '03',
        label: 'Guyane',
        options: [{ value: '973', label: 'Guyane (973)' }],
    },
    {
        id: '32',
    ...
    },
    {
        id: '04',
        label: 'La Réunion',
        options: [{ value: '974', label: 'La Réunion (974)' }],
    },
    {
        id: '02',
        label: 'Martinique',
        options: [{ value: '972', label: 'Martinique (972)' }],
    },
    {
        id: '06',
        label: 'Mayotte',
        options: [{ value: '976', label: 'Mayotte (976)' }],
    },
    {
        id: '28',
        label: 'Normandie',
